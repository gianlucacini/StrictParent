...
namespace Unplug.BusinessLayer
{
    public class AppStatusService
    {
        ...
        public static DateTime[] ParseCorrectDateTime(DateTime now, String fromTimeStr, String untilTimeStr)
        {
        ...
        public static StatusResponse CalculateStatusInterval(DateTime now, DateTime unplugFrom, DateTime unplugUntil)
        {
